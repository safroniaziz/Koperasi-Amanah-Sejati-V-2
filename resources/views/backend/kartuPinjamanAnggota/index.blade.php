        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-calendar"></i>&nbsp;Kartu Pinjaman Anggota</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        ...
                        <tbody>
                            ...
                            @forelse ($anggotas as $index => $anggota)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kartuPinjaman.detail',[$anggota->id]) }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-search"></i>&nbsp;Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
